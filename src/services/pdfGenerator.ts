...
export class PDFGenerator {
  ...
  generateReport(
    ...
    this.addTopVariablesSection(data, insights.topVariablesAnalysis, charts.pieChart);
  ...
  private addTopVariablesSection(
    data: ExperimentData,
    analysis: string,
    ...
    // Add pie chart
    this.addChartImage(pieChartImage, 140, 80);
  ...
  private addVariableImpactSection(
    data: ExperimentData,
    insights: string
  ): void {
